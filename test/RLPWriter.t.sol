...
import { RLPWriter } from "../src/rlp/RLPWriter.sol";
import {DSTestPlus} from "solmate/test/utils/DSTestPlus.sol";
import {AssertBytes} from "./helpers/AssertBytes.sol";

contract RLPWriter_Test is DSTestPlus {
    function test_writeString_empty() external {
        assertTrue(AssertBytes.equal(RLPWriter.writeString(""), hex"80"));
    }

    function test_writeString_bytestring00() external {
        assertTrue(AssertBytes.equal(RLPWriter.writeString("\u0000"), hex"00"));
    }

    function test_writeString_bytestring01() external {
        assertTrue(AssertBytes.equal(RLPWriter.writeString("\u0001"), hex"01"));
    }

    function test_writeString_bytestring7f() external {
        assertTrue(AssertBytes.equal(RLPWriter.writeString("\u007F"), hex"7f"));
    }

    function test_writeString_shortstring() external {
        assertTrue(AssertBytes.equal(RLPWriter.writeString("dog"), hex"83646f67"));
    }

    function test_writeString_shortstring2() external {
        assertTrue(AssertBytes.equal(
    ...
    function test_writeUint_zero() external {
        assertTrue(AssertBytes.equal(RLPWriter.writeUint(0x0), hex"80"));
    }

    function test_writeUint_smallint() external {
        assertTrue(AssertBytes.equal(RLPWriter.writeUint(1), hex"01"));
    }

    function test_writeUint_smallint2() external {
        assertTrue(AssertBytes.equal(RLPWriter.writeUint(16), hex"10"));
    }

    function test_writeUint_smallint3() external {
        assertTrue(AssertBytes.equal(RLPWriter.writeUint(79), hex"4f"));
    }

    function test_writeUint_smallint4() external {
        assertTrue(AssertBytes.equal(RLPWriter.writeUint(127), hex"7f"));
    }

    function test_writeUint_mediumint() external {
        assertTrue(AssertBytes.equal(RLPWriter.writeUint(128), hex"8180"));
    }

    function test_writeUint_mediumint2() external {
        assertTrue(AssertBytes.equal(RLPWriter.writeUint(1000), hex"8203e8"));
    }

    function test_writeUint_mediumint3() external {
        assertTrue(AssertBytes.equal(RLPWriter.writeUint(100000), hex"830186a0"));
    }

    function test_writeList_empty() external {
        assertTrue(AssertBytes.equal(RLPWriter.writeList(new bytes[](0)), hex"c0"));
    }
    ...
    function test_writeList_stringList() external {
        ...
        assertTrue(AssertBytes.equal(RLPWriter.writeList(list), hex"cc83646f6783676f6483636174"));
    }
    ...
    function test_writeList_multiList() external {
        ...
        assertTrue(AssertBytes.equal(RLPWriter.writeList(list), hex"c6827a77c10401"));
    }
    ...
    function test_writeList_listoflists() external {
        ...
        assertTrue(AssertBytes.equal(RLPWriter.writeList(list), hex"c4c2c0c0c0"));
    }
    ...
    function test_writeList_listoflists2() external {
        ...
        assertTrue(AssertBytes.equal(RLPWriter.writeList(list), hex"c7c0c1c0c3c0c1c0"));
    }
