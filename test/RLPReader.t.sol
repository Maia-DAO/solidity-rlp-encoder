...
import { RLPReader } from "../src/rlp/RLPReader.sol";
...
contract RLPReader_Test is DSTestPlus {
    function test_readBytes_bytestring00() external {
        assertTrue(AssertBytes.equal(RLPReader.readBytes(hex"00"), hex"00"));
    }

    function test_readBytes_bytestring01() external {
        assertTrue(AssertBytes.equal(RLPReader.readBytes(hex"01"), hex"01"));
    }

    function test_readBytes_bytestring7f() external {
        assertTrue(AssertBytes.equal(RLPReader.readBytes(hex"7f"), hex"7f"));
    }
    ...
    function test_readList_multiList() external {
        ...
        assertTrue(AssertBytes.equal(RLPReader.readRawBytes(list[0]), hex"827a77"));
        assertTrue(AssertBytes.equal(RLPReader.readRawBytes(list[1]), hex"c104"));
        assertTrue(AssertBytes.equal(RLPReader.readRawBytes(list[2]), hex"01"));
    }
    ...
    function test_readList_shortListMax1() external {
        ...
        assertTrue(AssertBytes.equal(RLPReader.readRawBytes(list[0]), hex"8461736466"));
        assertTrue(AssertBytes.equal(RLPReader.readRawBytes(list[1]), hex"8471776572"));
        assertTrue(AssertBytes.equal(RLPReader.readRawBytes(list[2]), hex"847a786376"));
        assertTrue(AssertBytes.equal(RLPReader.readRawBytes(list[3]), hex"8461736466"));
        assertTrue(AssertBytes.equal(RLPReader.readRawBytes(list[4]), hex"8471776572"));
        assertTrue(AssertBytes.equal(RLPReader.readRawBytes(list[5]), hex"847a786376"));
        assertTrue(AssertBytes.equal(RLPReader.readRawBytes(list[6]), hex"8461736466"));
        assertTrue(AssertBytes.equal(RLPReader.readRawBytes(list[7]), hex"8471776572"));
        assertTrue(AssertBytes.equal(RLPReader.readRawBytes(list[8]), hex"847a786376"));
        assertTrue(AssertBytes.equal(RLPReader.readRawBytes(list[9]), hex"8461736466"));
        assertTrue(AssertBytes.equal(RLPReader.readRawBytes(list[10]), hex"8471776572"));
    }
    ...
    function test_readList_longList1() external {
        ...
        assertTrue(AssertBytes.equal(RLPReader.readRawBytes(list[0]), hex"cf84617364668471776572847a786376"));
        assertTrue(AssertBytes.equal(RLPReader.readRawBytes(list[1]), hex"cf84617364668471776572847a786376"));
        assertTrue(AssertBytes.equal(RLPReader.readRawBytes(list[2]), hex"cf84617364668471776572847a786376"));
        assertTrue(AssertBytes.equal(RLPReader.readRawBytes(list[3]), hex"cf84617364668471776572847a786376"));
    }
    ...
    function test_readList_longList2() external {
        ...
        for (uint256 i = 0; i < 32; i++) {
            assertTrue(AssertBytes.equal(RLPReader.readRawBytes(list[i]), hex"cf84617364668471776572847a786376"));
        }
    }
    ...
    function test_readList_listOfLists() external {
        ...
        assertTrue(AssertBytes.equal(RLPReader.readRawBytes(list[0]), hex"c2c0c0"));
        assertTrue(AssertBytes.equal(RLPReader.readRawBytes(list[1]), hex"c0"));
    }
    ...
    function test_readList_listOfLists2() external {
        ...
        assertTrue(AssertBytes.equal(RLPReader.readRawBytes(list[0]), hex"c0"));
        assertTrue(AssertBytes.equal(RLPReader.readRawBytes(list[1]), hex"c1c0"));
        assertTrue(AssertBytes.equal(RLPReader.readRawBytes(list[2]), hex"c3c0c1c0"));
    }
    ...
    function test_readList_dictTest1() external {
        ...
        assertTrue(AssertBytes.equal(RLPReader.readRawBytes(list[0]), hex"ca846b6579318476616c31"));
        assertTrue(AssertBytes.equal(RLPReader.readRawBytes(list[1]), hex"ca846b6579328476616c32"));
        assertTrue(AssertBytes.equal(RLPReader.readRawBytes(list[2]), hex"ca846b6579338476616c33"));
        assertTrue(AssertBytes.equal(RLPReader.readRawBytes(list[3]), hex"ca846b6579348476616c34"));
    }
